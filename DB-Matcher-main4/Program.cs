...
namespace DB_Matching_main1
{
    ...
    internal class Program
    {
        ...
        static void run(bool jsonCheck = true)
        {
     ...
     =========**********       XXXXXXXXXXXXXXXXXXXXXX";
        ...
        static int getIntOrDefault(int defaultValue)
        {
            string inputHold1 = Console.ReadLine();
        ...
        static void printFittedSizeAsterixRow()
        {
            Console.WriteLine();
        ...
        static void printFittedSizeAsterixRowCompact()
        {
            string outputHold = "";
            for (int cnt = 0; cnt < Console.WindowWidth; cnt++)
            {
        ...
        static void printFittedSizeHashtagRow()
        {
            Console.WriteLine();
            for (int cnt = 0; cnt < Console.WindowWidth; cnt++)
            {
        ...
        static void printFittedSizeHashtagRowCompact()
        {
            for (int cnt = 0; cnt < Console.WindowWidth; cnt++)
            {
                Console.Write("#");
        ...
        static void printFittedSizeAsterixSurroundedText(string text)
        {
            VarHold varHold = new VarHold();
        ...
        static int getLastRowWithValue(IWorkbook workbook, int sheet, int column)
        {
        ...
        static int getLastColumnWithValue(IWorkbook workbook, int sheet, int row)
        {
            ISheet iSheet = workbook.GetSheetAt(sheet);
        ...
        static void writeToSettingsFile(string path, string settingName, string settingValue)
        {
            VarHold varHold = new VarHold();
        ...
        static string readFromSettingsFile(string path, string settingName)
        {
            Dictionary<string, string> settingsDict = new Dictionary<string, string>();
        ...
        static void createDictionary(string jsonPath)
        {
            VarHold varHold = new VarHold();
        ...
        static void setConsoleColorToRed() { Console.ForegroundColor = ConsoleColor.Red; }
        static void setConsoleColorToGreen() { Console.ForegroundColor = ConsoleColor.Green; }
        static void setConsoleColorToBlue() { Console.ForegroundColor = ConsoleColor.Blue; }
        static void setConsoleColorToBlack() { Console.ForegroundColor = ConsoleColor.Black; }
        static void setConsoleBackgroundColorToRed() { Console.BackgroundColor = ConsoleColor.Red; }
        static void setConsoleBackgroundColorToGreen() { Console.BackgroundColor = ConsoleColor.Green; }
        static void setConsoleBackgroundColorToBlue() { Console.BackgroundColor = ConsoleColor.Blue; }
        static void resetConsoleColor() { Console.ResetColor(); }
    }
